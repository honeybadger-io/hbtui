...
- [Adopt architecture decision records](0001-adopt-architecture-decision-records.md) (accepted, 2026-02-21)
- [Use notify crate for dashboard file watching with hot-reload](0002-use-notify-crate-for-dashboard-file-watching-with-hot-reload.md) (accepted, 2026-02-21)